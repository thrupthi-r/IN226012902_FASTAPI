...
products = [
    ...
    {'id': 5, 'name': 'Laptop Stand',     'price': 499, 'category': 'Electronics', 'in_stock': True },
    {'id': 6, 'name': 'Mechanical Keyboard',     'price':  899, 'category': 'Stationery',  'in_stock': True},
